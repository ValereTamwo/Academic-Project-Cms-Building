...
<html lang="en">
    ...
    <body>
        ...
        <div class="contactez-nous">
            <h1> Activites</h1>
            <p>Poster des activites annonces sur le site !</p>
        ...
        <div class="update">
            <ul>
                <li><button id="update" onclick="document.location.href='updateactivite.php'">Modifier
                        Activite</button></li>
                <li><button id="updat">Suprimer Activite </button></li>
            </ul>
...
insertActivite($_SESSION['id'], $_POST['activite1'], $file_dest1, $_POST['activite2'], $file_dest2, $_POST['activite3'], $file_dest3, $_POST['activite4'], $file_dest4, $_POST['activite5'], $file_dest5, $_POST['activite6'], $file_dest6);
